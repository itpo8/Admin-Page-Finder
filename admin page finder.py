...
''')
    print (color.RED+ '                           Coded By Po0ri4')
    print (color.RED+ '                            Insta => itpo8')
    print (color.RED+ '                            Github=> itpo8')
    print('')
    var1=0
    var2=0

    php = ['admin/','administrator/','admin1/','admin2/','admin3/','login','app/login','wp-login.php','admin4/','admin5/','usuarios/','usuario/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php']
    ...
    asp = ['Home/tabid/36/ctl/Login/Default.aspx','login.aspx','Login','admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.cfm','adm.cfm','affiliate.cfm','adm_auth.cfm','memberadmin.cfm','administratorlogin.cfm']
    ...
    js = ['Login','admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    if code==1:
        print(color.RED+'\t [+] Scanning ' + site + "...\n\n")
        for admin in php:
            admin = admin.replace("\n","")
            admin = "/" + admin
            host = site + admin
            print (color.WHITE+'\t [#]  ' + host )
            ...
            if response.status == 200:
                ...
                print color.GREEN+ ('>>> Maby - Redirect')
            else:
                print color.RED+('>>> ' + host +  ' Interesting response : 301')
            connection.close()
        print color.banafsh+('\n\nCompleted\n\n')
